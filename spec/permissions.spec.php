...
describe(\ChildPagePermissions\Permissions::class, function () {
    beforeEach(function () {
        \WP_Mock::setUp();
        $this->editorTypeCaps = [
            'edit_pages' => true,
        ...
        $this->permissions = new ChildPagePermissions\Permissions($this->user, $this->settings);
    });
    ...
    describe('->updateByPage()', function () {
        ...
        context('is a page', function () {
            ...
            context('user can edit_users', function () {
                ...
                context('child_page_permissions_form_exists not set', function () {
                    it('does nothing', function () {
                        global $_POST;
                        $_POST = [];
                        $_POST['child_page_permissions'] = [
                            'some' => 'values',
                            'that' => 'should',
                            'not' => 'save'
                        ];
                ...
                context('child_page_permissions_form_exists is set', function () {
                    context('child_page_permissions is not set', function () {
                        it('does nothing', function () {
                            global $_POST;
                            $_POST = [];
                            $_POST['child_page_permissions_form_exists'] = true;
                            WP_Mock::wpFunction('update_post_meta', [
                                'times' => 0
                            ]);
                            $this->permissions->updateByPage($this->postID, $this->post);
                    ...
                    context('child_page_permissions is set', function () {
