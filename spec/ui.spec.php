...
describe(\ChildPagePermissions\UI::class, function () {
    beforeEach(function () {
        \WP_Mock::setUp();
        $this->user = Mockery::mock(\ChildPagePermissions\User::class);
        $this->permissions = Mockery::mock(\ChildPagePermissions\Permissions::class);
        $this->settings = Mockery::mock(\ChildPagePermissions\Settings::class);
        $this->settings->shouldReceive('pluginName')
            ->andReturn('Child Page Permissions');
        $this->settings->shouldReceive('pluginID')
            ->andReturn('child_page_permissions');
        $this->settings->shouldReceive('metakey')
            ->andReturn('_child_page_permissions');
        $this->ui = new ChildPagePermissions\UI($this->user, $this->permissions, $this->settings);
    });
        ...
        context('page has no parent', function () {
            ...
            context('current user cannot edit_users', function () {
                it('outputs box with disabled controls', function () {
                    ...
                    $this->ui->metaBoxOutput();
                    $result = ob_get_clean();
                    expect($result)->to->equal('<input name="child_page_permissions_form_exists" type="hidden" value="true"><ol><li><label><input name="child_page_permissions[45]" type="checkbox" checked disabled>foo</label></li><li><label><input name="child_page_permissions[67]" type="checkbox" disabled>bar</label></li><li><label><input name="child_page_permissions[89]" type="checkbox" checked disabled>gem</label></li></ol>');
                });
            });
            context('current user can edit_users', function () {
                it('outputs box with enabled controls', function () {
                    ...
                    $this->ui->metaBoxOutput();
                    $result = ob_get_clean();
                    expect($result)->to->equal('<input name="child_page_permissions_form_exists" type="hidden" value="true"><ol><li><label><input name="child_page_permissions[45]" type="checkbox" checked>foo</label></li><li><label><input name="child_page_permissions[67]" type="checkbox">bar</label></li><li><label><input name="child_page_permissions[89]" type="checkbox" checked>gem</label></li></ol>');
                });
            });
        });
    });
    ...
    describe('filterPageDropdown()', function () {
        context('user is admin', function () {
            it('returns the output unamended', function () {
                ...
                $this->output = '<select name="parent_id" id="parent_id"><option value="">(no parent)</option><option class="level-0" value="102035" selected="selected">About This Website</option><option class="level-1" value="103760">&nbsp;&nbsp;&nbsp;test perm</option><option class="level-2" value="103762">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;test perm child</option><option class="level-3" value="103764">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;child child</option><option class="level-4" value="103802">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sds</option></select>';
        ...
        context('user is not admin', function () {
            beforeEach(function () {
                ...
                $this->output = '<select name="parent_id" id="parent_id"><option value="">(no parent)</option><option class="level-0" value="123" selected="selected">About This Website</option><option class="level-1" value="456">&nbsp;&nbsp;&nbsp;test perm</option><option class="level-2" value="789">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;test perm child</option></select>';
            });
            ...
            context('editing a page', function () {
                ...
                context('user has access to all pages in dropdown', function () {
                    it('just removes no parent option', function () {
                        ...
                        expect($result)->to->equal('<select name="parent_id" id="parent_id"><option class="level-0" value="123" selected>About This Website</option><option class="level-1" value="456">&nbsp;&nbsp;&nbsp;test perm</option><option class="level-2" value="789">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;test perm child</option></select>');
                    });
                });
